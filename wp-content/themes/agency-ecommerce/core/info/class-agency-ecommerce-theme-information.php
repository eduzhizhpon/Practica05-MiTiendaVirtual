...
include_once 'customizer/class-agency-ecommerce-customizer-upsell.php';
...
if (!class_exists('Agency_Ecommerce_Theme_Information')) {
    ...
    class Agency_Ecommerce_Theme_Information
    {
        ...
        public static $documentation_link = 'https://mantrabrain.com/docs-category/agency-ecommerce/';
